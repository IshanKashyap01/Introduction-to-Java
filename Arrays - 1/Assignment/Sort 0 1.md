...
solution which scans the array/list only once and don't require use of an extra
array/list.

**Note**:

You need to change in the given array/list itself. Hence, no need to return or
print anything.
