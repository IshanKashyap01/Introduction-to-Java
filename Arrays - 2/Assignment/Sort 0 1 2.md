...
1. You need to change in the given array/list itself. Hence, no need to return
or print anything.
...
the array in a single scan, the 0s should come first, then the 1s, and finally
the 2s. So the output is 0 0 0 1 1 2 2.
...
1. The array contains one 0, two 1s, and two 2s. After sorting, the 0 comes
first, then the 1s, and finally the 2s. So the output is 0 1 1 2 2.

2. The array contains three 0s, two 1s, and two 2s. After sorting, the 0s come
first, then the 1s, and finally the 2s. So the output is 0 0 0 1 1 2 2.
```
