...
string's characters can be rearranged so that it becomes identical to the other
one.
...
The only line of output prints either 'true' or 'false', denoting whether the
two strings are a permutation of each other or not.
