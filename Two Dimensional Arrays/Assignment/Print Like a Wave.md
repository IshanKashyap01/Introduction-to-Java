...
sine wave order in a single line, separated by a single space.
...
70 80 90
Sample Output 2:
1 4 7 10 13 14 11 8 5 2 3 6 9 12 15 10 40 70 80 50 20 30 60 90 
```
...
public class Solution 
{
    public static void wavePrint(int mat[][])
    {
        ...
        boolean swap = true;
        for(int j = 0; j < mat[0].length; j++, swap = !swap)
        {
            if(swap)
            {
