...
For a given two-dimensional integer array/list of size (N x M), find and print
the sum of each of the row elements in a single line, separated by a single
space.
...
For each test case, print the sum of every ith row elements in a single line
