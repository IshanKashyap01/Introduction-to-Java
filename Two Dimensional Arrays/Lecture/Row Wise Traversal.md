...
You must return an integer array of size ‘N’ * ‘M’ denoting the row-wise
...
Output :
4 3 2 1
Explanation: For the given matrix, the first row is [4, 3], and the second is
[2, 1].
...
{
    public static int[] printRowWise(int[][] mat) 
    {
